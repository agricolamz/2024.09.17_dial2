...
```{r}
#| out-height: 73%
#| fig-cap: "Dialect polygones by I. A. Marchenko, created with `lingytpology` [@moroz17]"

knitr::include_graphics("images/dial_num_constr_map.png")
```
...
Example of 'other' context: *ne bylo cerkv\alert{ov}* (stand *cerkv\alert{ej}*) ‘the was no churches’

## Pearson correlation coefficient: 0.699

```{r}
#| out-width: 110%

knitr::include_graphics("images/dial_num_constr_correlation.png")
```
...
knitr::include_graphics("images/dial_num_constr_year_of_birth.png")
```
...
knitr::include_graphics("images/dial_num_constr_years_of_education.png")
```

## Is the collocationality significant?

```{r}
#| out-width: 110%

knitr::include_graphics("images/dial_num_constr_collocationality.png")
```
...
knitr::include_graphics("images/dial_num_constr_collocationality_num_type.png")
```
...
- Looking for the mistakes in the corpora manually is time-consuming.
- Standard spell-checking algorithms are ineffective for cleaning collected data due to the presence of non-literary wordforms.
- Spell-checkers for the literary Russian treat dialectal wordforms as spelling errors.
    - *Они все разъехадчи* —> *Они все разъехались*
- Objective: create a mechanism for automatic search for errors and typos.
- It is crucial for a future mechanism to distinguish between a typo and a dialectal wordform.

## Hapax Legomena

- First Approach: Analyze hapax legomena (tokens that appear only once in the corpora) to identify typos.
- Pipeline:
    - Select all hapax legomena
    - Put them in the normal form
    - Check with a spellchecker and dictionaries.
- Results: Low effectiveness, most part of the hapax legomena are not typos.
    - Out of 2000 hapax legomena, only 10 were typos.
...
```
[('вот', 'O'), ('сейчас', 'O'), ('вот', 'O'), ('я', 'O'), ('тоже', 'O'), 
('ездиала', 'E'), ('на', 'O'), ('автобусе', 'O'), ('ну', 'O'), 
('но', 'O'), ('уже', 'O'), ('наверно', 'D'), ('с', 'O'), ('месяц', 'O'),
('не', 'O'), ('ездию', 'D'), ('ну', 'O')]
```
