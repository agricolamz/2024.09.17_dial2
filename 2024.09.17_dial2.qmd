...
- Multiple sociolinguistic fieldtrips to Daghestan
- Several dialect fieldtrips to Ustya \pause
...
\alert{Can we find variation patterns?}
\vfill
...
Example of 'other' contexts: *ne bylo cerkv\alert{ov}* (stand *cerkv\alert{ej}*) ‘there were no churches’
...
knitr::include_graphics("images/l2_neg_exist_constr_stats.png")
```
...
- Results: Low effectiveness, most part of the hapax legomena are not typos
    - Out of 2,000 hapax legomena, only 10 were typos
...
- create more corpora
    - we can do this within the Lab too (thanks to `whisper` speech to text model) \pause
